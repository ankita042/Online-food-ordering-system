...
body{background:url(a5.jpg);}
	.a{background-color:rgba(21,43,211,0.2);height:250px;margin:4px;padding:2%;;font-family:arial;font-size:2vw;}
</style>
...
<?php
	...
	$q="select * from bill where vendor_id= '".$_SESSION['vendorid']."' and status='n'";
