...
body{background:url(a5.jpg);}
	.a{background-color:#d8a8f7;height:250px;margin:10px;}
	...
	right:2%;width:45%;font-family:arial;font-size:1.5vw;top:10%;}
</style>
...
<?php
	...
	$q="select * from product where vendor_id='".$_SESSION['vendorid']."'";
